...
//Route::group(['prefix'=>'adminpanel'], function () {
  ...
  Route::any('deleteuser', 'UsersController@deleteUser')->name('delete.users');
  ...
  Route::any('getselpartner', 'ProductPartnerController@getSelectedPartner')->name('get.selpartner');
  ...
  Route::post('fetchbank', 'ProductPartnerController@fetchBank')->name('fetch.bank');
  ...
  Route::resource('partner-code','PartnerCodeController');
  Route::any('getpartnercode', 'PartnerCodeController@getPartnercode')->name('get.partnercode');
  Route::post('partner-code/update/{id}','PartnerCodeController@update')->name('partnercode.updates');
  Route::post('partner-code/store','PartnerCodeController@store')->name('partnercode.link');
  Route::any('deletePartnerCode/{id}', 'PartnerCodeController@deletePartnerCode');
  ...
  Route::post('product/fetch','ProductController@fetch')->name('dynamicdependent.fetch');
  ...
  Route::get('download-report', 'ReportingController@exportExcel')->name('download.excelreporting');
  ...
  Route::resource('switch-automation', 'SwitchAutomationController');

  Route::post('getPricePerPartner','SwitchingController@getSwitchByPrice')->name('get.switchbyprice'); // tes function
  Route::get('get-collection-partner', 'SwitchAutomationController@getCollectionPartner')->name('get.collectionpartner');
  Route::post('store-switching-custom-detail', 'SwitchAutomationController@storeDetail')->name('post.storeswitchingautomation');
  Route::post('delete-switching-custom-detail', 'SwitchAutomationController@deleteDetail')->name('post.deleteswitchingcustomdetail');
  Route::get('get-switching-custom-detail', 'SwitchAutomationController@getListSwitchingCustomDetail')->name('get.switchingcustomdetail');
  ...
  Route::get('getauditall', 'AuditTrailController@getauditall')->name('get.audit-all');
