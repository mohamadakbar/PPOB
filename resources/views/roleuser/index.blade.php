...
@section('content')
    <div class="panel panel-default">
      <div class="panel-body">
          <a id="btnNew" class="btn btn-info fz13 btn-sm" href="{{ route('roleusers.create') }}">New</a>
           ...
           var arrId = [];
            $.each(check, function(index, rowId){
              ...
              type: "success",
                  ...
                  setTimeout(function () {        
                    window.location = "{{ route('roleusers.index') }}";
                  },50);
                });
            });
        });
